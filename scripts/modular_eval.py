...
def modular_eval(
    ...
    for ex in tqdm(retr_results):
        ...
        for n in cutoff_list:
            ...
            retriever_scores_at_n[n]['ndcg'].append(compute_ndcg_at_k(pred_doc_ids_retr, gold_doc_ids, k=n))
            retriever_scores_at_n[n]['hit'].append(int(evidence_match(pred_doc_ids_retr, gold_evidence)))
